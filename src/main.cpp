...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "racecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Racecoin is comming !!!! 3 2 1 go.";
        CTransaction txNew;
        txNew.nTime = 1407786834;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1407786834;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 11680656;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2c63529cd84421bb7ecd98a016421d1de63fa17d5d6153e12d3679fce69705b1"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd4, 0x02, 0xfc, 0xa1 };
