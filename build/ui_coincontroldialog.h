...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 RACE"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 RACE"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 RACE"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 RACE"));
