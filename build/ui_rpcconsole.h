...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "racecoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "racecoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the racecoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the racecoin-Qt help message to get a list with possible racecoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
